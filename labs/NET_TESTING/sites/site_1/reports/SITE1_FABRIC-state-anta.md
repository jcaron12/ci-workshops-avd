...
| ------------------| ----------- | ------------ | ------------ | ------------- | ----------------- | ------------------ |
| s1-brdr1 | 52 | 42 | 6 | 4 | BGP, Connectivity | Hardware |
...
| s1-spine1 | 38 | 31 | 3 | 4 | BGP, Connectivity | Hardware |
| s1-spine2 | 38 | 31 | 3 | 4 | BGP, Connectivity | Hardware |
...
| -- | ----------------- | ---------- | ---- | ----------- | ------ | -------| -------- |
| 4 | s1-brdr1 | BGP | VerifyBGPSpecificPeers | Verifies the health of specific BGP peer(s) for given address families. | BGP IPv4 Unicast Peer: s1-spine1 (IP: 172.16.1.16) | FAIL | AFI: ipv4 SAFI: unicast VRF: default Peer: 172.16.1.16 - Session state is not established - State: Connect |
| 5 | s1-brdr1 | BGP | VerifyBGPSpecificPeers | Verifies the health of specific BGP peer(s) for given address families. | BGP IPv4 Unicast Peer: s1-spine2 (IP: 172.16.1.18) | FAIL | AFI: ipv4 SAFI: unicast VRF: default Peer: 172.16.1.18 - Session state is not established - State: Connect |
...
| 361 | s1-spine2 | BGP | VerifyBGPSpecificPeers | Verifies the health of specific BGP peer(s) for given address families. | BGP IPv4 Unicast Peer: s1-brdr1 (IP: 172.16.1.19) | FAIL | AFI: ipv4 SAFI: unicast VRF: default Peer: 172.16.1.19 - Session state is not established - State: Connect |
